...
function mostrarCartelGanador(){
  document.getElementById("mensaje").innerHTML = "<h2>Felicitaciones has ganado!<h2>";
}
...
function intercambiarPosiciones(filaPos1, columnaPos1, filaPos2, columnaPos2){
  ...
  var vacioAnterior = filaPos1.toString() + columnaPos1.toString();
  var vacioNuevo = filaPos2.toString() + columnaPos2.toString();
  
  //buscar casilla en DOM
  var casillaVaciaAnterior = document.getElementById(vacioAnterior);
  var casillaVaciaNueva = document.getElementById(vacioNuevo);

  var clonC1 = casillaVaciaAnterior.cloneNode(true);
  var clonC2 = casillaVaciaNueva.cloneNode(true);

  casillaVaciaAnterior.innerHTML = clonC2.innerHTML;
  casillaVaciaNueva.innerHTML = clonC1.innerHTML;
}
